...
/* Ответ: в примере 3 теста => тест функции лучше разбить на несколько блоков it 
          с полным и понятным описанием входных и выходных данных;
          основной блок it следует заменить на describe
